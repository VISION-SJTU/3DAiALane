...
model_path = './trained_models/aia/latest.pth' #model path of verification
...
tmp_save_path = './trained_models/tmp_result' #tmp path for save intermediate result
...
def val():
    ...
    lane_eval.show()
    print('speed: ',16/np.mean(time_spent),' fps')
