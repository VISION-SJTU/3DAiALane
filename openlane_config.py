...
''' data split '''
train_gt_paths = '../openlane/lane3d_1000/training'
train_image_paths = '../openlane/images/training'
val_gt_paths = '../openlane/lane3d_1000/validation'
val_image_paths = '../openlane/images/validation'

model_save_path = "./trained_models/aia"
